...
namespace QLNS_AT
{
    public partial class FrmKenhKyThuat : Form
    {
        Ketnoi data = new Ketnoi();
        string manv = "";
        public FrmKenhKyThuat(string manv)
        {
            InitializeComponent();
            this.manv = manv;
        }
        ...
        private void FrmKenhKyThuat_Load(object sender, EventArgs e)
        {
            loadData();
            txtTN.Focus();
        }
        ...
        private void btnGui_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                data.ExecuteNonQuery("insert into LoiNhan values('" + manv + "', N'" + tinnhan + "', Getdate(), N'Kỹ thuật')");
                loadData();
            }
            catch (Exception ex)
            {
