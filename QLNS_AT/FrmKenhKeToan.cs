...
namespace QLNS_AT
{
    public partial class FrmKenhKeToan : Form
    {
        Ketnoi data = new Ketnoi();
        string manv = "";
        public FrmKenhKeToan(string manv)
        {
            InitializeComponent();
            this.manv = manv;
        }
        ...
        private void FrmKenhKeToan_Load(object sender, EventArgs e)
        {
            loadData();
            txtTN.Focus();
        }
        ...
        private void btnGui_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                data.ExecuteNonQuery("insert into LoiNhan values('" + manv + "', N'" + tinnhan + "', Getdate(), N'Kế toán')");
                loadData();
            }
            catch (Exception ex)
            {
