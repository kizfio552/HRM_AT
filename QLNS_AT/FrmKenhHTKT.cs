...
namespace QLNS_AT
{
    public partial class FrmKenhHTKT : Form
    {
        Ketnoi data = new Ketnoi();
        string manv = "";
        public FrmKenhHTKT(string manv)
        {
            InitializeComponent();
            this.manv = manv;
        }
        ...
        private void FrmKenhHTKT_Load(object sender, EventArgs e)
        {
            loadData();
            txtTN.Focus();
        }
        ...
        private void btnGui_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                data.ExecuteNonQuery("insert into LoiNhan values('" + manv + "', N'" + tinnhan + "', Getdate(), N'Hỗ trợ kỹ thuật')");
                loadData();
            }
            catch (Exception ex)
            {
