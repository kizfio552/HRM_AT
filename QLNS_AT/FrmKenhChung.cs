...
namespace QLNS_AT
{
    public partial class FrmKenhChung : Form
    {
        Ketnoi data = new Ketnoi();
        string manv = "";
        public FrmKenhChung(string manv)
        {
            InitializeComponent();
            this.manv = manv;
        }
        ...
        private void FrmKenhChung_Load(object sender, EventArgs e)
        {
            loadData();
            txtTN.Focus();
        }
        ...
        private void btnGui_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                data.ExecuteNonQuery("insert into LoiNhan values('" + manv + "', N'" + tinnhan + "', Getdate(), N'Chung')");               
                loadData();
            }
            catch (Exception ex)
            {
